...
import org.terasology.rendering.assets.mesh.TechneMeshLoader;
...
public enum AssetType {
    ...
    MESH("mesh", "mesh", new String[]{"obj", "dae", "tcn"}, new AssetLoader[]{new ObjMeshLoader(), new ColladaMeshLoader(), new TechneMeshLoader()}, false),
